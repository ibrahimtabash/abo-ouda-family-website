<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">تعديل مهنة</h2>
    </x-slot>
                    ...
                    <form action="{{ route('professions.update', $profession->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name"
                                value="{{ old('name', $profession->name) }}" required
                        ...
                        <button type="submit"
                            class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition">تحديث</button>
                    </form>
                </div>
            </div>
        </div>
